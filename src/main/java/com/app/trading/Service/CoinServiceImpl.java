...
public class CoinServiceImpl implements CoinService {
	...
	public String getCoinDetails(String coinId) throws Exception {
		...
		try {
			...
			coin.setPriceChange24h(marketData.path("price_change_24h").path("usd").asDouble(0.0));
			coin.setPriceChangePercentage24h(marketData.path("price_change_percentage_24h").asDouble(0.0));
			coin.setMarketCapChange24h(marketData.path("market_cap_change_24h").asLong(0L));
